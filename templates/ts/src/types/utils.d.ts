...
export type UserResponse = Omit<import('../models/userModel').IUser, 'password'>;

// Pick only essential user fields
export type UserSafe = Pick<import('../models/userModel').IUser, '_id' | 'username' | 'email' | 'createdAt' | 'updatedAt'>;

// Make all properties optional (for updates)
export type PartialUser = Partial<import('../models/userModel').IUser>;
